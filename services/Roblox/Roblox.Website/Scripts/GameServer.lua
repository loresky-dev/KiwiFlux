local url, port, placeId, creatorId, placeVersionId, vipServerOwnerId = ...
...
if url~=nil then
	...
	game:GetService("Players"):SetSysStatsUrl(url .. "/gs/players/report-sys-stats?apiKey=qr13q9rqeiofjlfadefjlaedfjoiaqoipjfaoijg")
...
local function reportPlayerEvent(userId, t)
	...
	local ok, msg = pcall(function()
		local msg = http:JSONEncode({
			["authorization"] = "qr13q9rqeiofjlfadefjlaedfjoiaqoipjfaoijg",
			["serverId"] = game.JobId,
