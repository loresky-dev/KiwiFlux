...
Roblox.Configuration.RCCServiceDirectory = configuration.GetSection("Directories:RCCServicePath").Value;
...
CommandHandler.Configure(configuration.GetSection("Render:BaseUrl").Value);
