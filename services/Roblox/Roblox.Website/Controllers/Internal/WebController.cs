...
public class WebController : ControllerBase
{
    ...
    public async Task<dynamic> AssetThumbnailJSON([Required] long assetId)
    {
    ...
    public async Task<dynamic> GetJoinScript(long placeId)
    {
        ...
        string clientYear = placeId == 1294 ? "2018L" : "2016E"; 
        ...
        var bootstrapperArgs = $":1+launchmode:play+gameinfo:{Request.Cookies[".ROBLOSECURITY"]}+client:{clientYear}+placelauncherurl:https://www.economy-simulator.org/game/PlaceLauncher.ashx?placeId={placeId}+k:l";
        var args =
        ...
        return new
        {
            ...
            prefix = "economysimulator-player",
            retroArgs = args
        };
    }
