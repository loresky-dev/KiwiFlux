...
public class GroupsService : ServiceBase, IService
{
    ...
    // Example URL (www is optional): https://www.economy-simulator.org/groups/1/name#!/about
    private static readonly Regex RobloxGroupUrlRegex = new("https:\\/\\/(www\\.)?economy-simulator.org\\/groups\\/[0-9]+\\/[a-zA-Z\\-0-9]+", RegexOptions.IgnoreCase);
    
    // Example URL (www is optional): https://economy-simulator.org/My/Groups.aspx?gid=4
    private static readonly Regex RobloxGroupUrlRegexOld = new("https:\\/\\/(www\\.)?economy-simulator.org\\/my\\/groups\\.aspx\\?gid=[0-9]+", RegexOptions.IgnoreCase);
